...
# SimpleSA
NaiveSimpleSA_2_16 = SimpleSA(mu=2, llambda=16).set_name("NaiveSimpleSA_2_16", register=True)
NaiveSimpleSA_2_32 = SimpleSA(mu=2, llambda=32).set_name("NaiveSimpleSA_2_32", register=True)
NaiveSimpleSA_2_64 = SimpleSA(mu=2, llambda=64).set_name("NaiveSimpleSA_2_64", register=True)
NaiveSimpleSA_2_128 = SimpleSA(mu=2, llambda=128).set_name("NaiveSimpleSA_2_128", register=True)
NaiveSimpleSA_4_16 = SimpleSA(mu=4, llambda=16).set_name("NaiveSimpleSA_4_16", register=True)
NaiveSimpleSA_4_32 = SimpleSA(mu=4, llambda=32).set_name("NaiveSimpleSA_4_32", register=True)
NaiveSimpleSA_4_64 = SimpleSA(mu=4, llambda=64).set_name("NaiveSimpleSA_4_64", register=True)
NaiveSimpleSA_4_128 = SimpleSA(mu=4, llambda=128).set_name("NaiveSimpleSA_4_128", register=True)
NaiveSimpleSA_8_16 = SimpleSA(mu=8, llambda=16).set_name("NaiveSimpleSA_8_16", register=True)
NaiveSimpleSA_8_32 = SimpleSA(mu=8, llambda=32).set_name("NaiveSimpleSA_8_32", register=True)
NaiveSimpleSA_8_64 = SimpleSA(mu=8, llambda=64).set_name("NaiveSimpleSA_8_64", register=True)
NaiveSimpleSA_8_128 = SimpleSA(mu=8, llambda=128).set_name("NaiveSimpleSA_8_128", register=True)
NaiveSimpleSA_16_64 = SimpleSA(mu=16, llambda=64).set_name("NaiveSimpleSA_16_64", register=True)
NaiveSimpleSA_16_128 = SimpleSA(mu=16, llambda=128).set_name("NaiveSimpleSA_16_128", register=True)
NaiveSimpleSA_32_64 = SimpleSA(mu=32, llambda=64).set_name("NaiveSimpleSA_32_64", register=True)
NaiveSimpleSA_32_128 = SimpleSA(mu=32, llambda=128).set_name("NaiveSimpleSA_32_128", register=True)
